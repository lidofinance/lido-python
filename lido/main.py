...
from lido.contracts.abi_loader import \
    get_default_lido_abi_path, get_default_operators_abi_path
...
class Lido:
    def __init__(
        ...
        self.registry_address = \
            registry_address or get_default_registry_address(self.chain_name)
        self.registry_abi_path = \
            registry_abi_path or get_default_operators_abi_path(
                self.chain_name)
        self.lido_address = \
